...
export default function PlaceCard({
  ...
  return (
    <aside className="flex h-[60vh] w-full min-h-0 flex-col overflow-hidden border-[#dadce0] bg-white lg:h-auto lg:min-h-0 lg:flex-[0_0_40%] lg:self-stretch lg:border-r">
      {heroPhoto && (
