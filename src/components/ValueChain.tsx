...
const steps = [
  ...
  },
  {
    ...
    description:
      "Prioritized GBP actions, each with a projected score impact. Review and approve before we publish.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description:
      "Calls, directions, and profile views — attributed back to each action. Results feed the next plan cycle.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="value-chain" className="relative scroll-mt-28 py-24 lg:py-32">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <SectionHeader
          ...
          subtitle="Every step feeds the next — and step 6 loops back to step 1. Your score, plan, and results improve recursively, not once."
        />
