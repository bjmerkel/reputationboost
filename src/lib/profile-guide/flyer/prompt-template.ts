...
export function buildFlyerBackgroundPromptTemplate(brief: FlyerDesignBrief): string {
  ...
  brief.profileGuideActions.length
    ...
    "",
    "Layout zones to preserve for overlays:",
    "• Top area: logo overlap zone",
    "• Center: headline/content card and optional lifestyle photo blend",
    "• Lower area: large square QR placement zone",
    "",
